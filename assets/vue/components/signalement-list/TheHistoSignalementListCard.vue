        ...
        <div class="fr-card__content fr-mb-1v">
          <div class="fr-grid-row">
            <div class="fr-col-xl-8 fr-col-lg-6 fr-col-12">
              ...
              <p class="fr-my-1v fr-text--bold fr-text--lg">17 boulevard saade - quai
                joliette, 13005
                Marseille</p>
            </div>
        ...
        <div class="fr-card__footer">
          <div class="fr-grid-row">
            <div class="fr-col-xl-8 fr-col-12">
              <p class="fr-my-1w"><span class="fr-icon-lightbulb-line"
                                        aria-hidden="true"></span>
                Procédure(s) suspectée(s):
                <span class="fr-badge fr-badge--sm fr-badge--warning fr-badge--no-icon">Manquement à la salubrité</span>
                <span class="fr-badge fr-badge--sm fr-badge--info fr-badge--no-icon">RSD / NON DÉCENCE</span>
              </p>
              <p class="fr-my-1w"><span class="fr-icon-briefcase-line"
                                        aria-hidden="true"></span>
                Partenaire(s) affecté(s) : EHMA - Métropole, ADIL, SOLIHA-DALO, SCHS de
                la commune</p>
              <p class="fr-my-1w"><span class="fr-icon-discuss-line"
                                        aria-hidden="true"></span>
          ...
          <div class="fr-grid-row">
            <div class="fr-col-12 fr-text--right">
              <button class="fr-btn fr-btn--icon-right fr-icon-arrow-right-line fr-mt-2w">
                Accéder au dossier
              </button>
            </div>
          </div>
