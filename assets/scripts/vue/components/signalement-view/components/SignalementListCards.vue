          ...
          <div class="fr-card__content">
            <div class="fr-grid-row">
              <div class="fr-col-xl-8 fr-col-lg-6 fr-col-12">
                <h3 class="fr-card__title fr-my-1v">
                  #{{ item.reference }}
                ...
                <p class="fr-my-1v">
                  <span class="fr-text--bold fr-text--lg">{{ item.addressHousenumber }} {{ item.addressStreet }}, {{ item.addressPostCode }} {{ item.addressCity }}</span>
            ...
            <div class="fr-col-12 fr-col-md-8 fr-col-lg-6">
                <div class="fr-modal__body">
                    ...
                    <div class="fr-modal__content">
                        ...
                        <ul>
                            <li>Le signalement sera supprimé, <strong>il ne sera plus accessible dans {{ sharedProps.platformName }}.</strong></li>
