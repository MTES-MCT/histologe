...
export default defineComponent({
  ...
  created () {
    if (initElements !== null) {
      ...
      this.sharedProps.injonctionBailleurDepts = JSON.parse(initElements.dataset.injonctionBailleurDepts)
  ...
  methods: {
    ...
    handleValidateAddress (requestResponse: any) {
      ...
      if (suggestion !== undefined) {
        formStore.data.adresse_logement_adresse_detail_commune = suggestion.properties.city // Pas idéal : ça modifie la valeur saisie par l'utilisateur, ça peut faire des vraies variations, même si l'intention est de standardiser la saisie
