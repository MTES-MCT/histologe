...
if (fieldsetVisitorType) {
  document
    .querySelectorAll('#radio-visitor-type-occupant, #radio-visitor-type-declarant')
    .forEach((element) => {
...
if (modalUploadFiles) {
  ...
  function typeValidation(file) {
    ...
    const message = document.createTextNode(
      "Impossible d'ajouter le fichier " +
        ...
        modalUploadFiles.dataset.acceptedExtensions +
        '.'
    );
  ...
  modalUploadFiles.addEventListener('dsfr.conceal', () => {
    if (
