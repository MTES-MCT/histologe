...
loadWindowWithLocalStorage(
  'click',
  '[data-filter-list-comptes-archives]',
  'search-archived-users-form'
);
updateLocalStorageOnEvent('input', '#comptes-archives-input', 'back_link_comptes_archives');
updateLocalStorageOnEvent(
  'change',
  '#comptes-archives-filters-territories',
  'back_link_comptes_archives'
);
updateLocalStorageOnEvent(
  'change',
  '#comptes-archives-filters-partners',
  'back_link_comptes_archives'
);
updateLocalStorageWithPaginationParams(
  'click',
  '#comptes-archives-pagination a',
  'back_link_comptes_archives'
);
