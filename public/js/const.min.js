                    ...
                    res.json().then((r) => {
                        e.querySelectorAll('.search-address-autocomplete-list')?.forEach((element) => {
                            ...
                            for (let feature of r.features) {
                                ...
                                suggestion.innerHTML = feature.properties.label;
                                suggestion.addEventListener('click', () => {
                                    e.querySelector('#edit-address-address').value = feature.properties.name;
                                    e.querySelector('#edit-address-address-hidden').value = feature.properties.name;
                                    e.querySelector('#edit-address-code-postal').value = feature.properties.postcode;
                                    e.querySelector('#edit-address-code-postal-hidden').value = feature.properties.postcode;
                                    e.querySelector('#edit-address-commune').value = feature.properties.city;
                                    e.querySelector('#edit-address-commune-hidden').value = feature.properties.city;
                                    e.querySelector('#edit-address-insee-hidden').value = feature.properties.citycode;
                                    e.querySelector('#edit-address-geoloc-lng-hidden').value = feature.geometry.coordinates[0];
                                    e.querySelector('#edit-address-geoloc-lat-hidden').value = feature.geometry.coordinates[1];
                                    element.innerHTML = '';
                                })
