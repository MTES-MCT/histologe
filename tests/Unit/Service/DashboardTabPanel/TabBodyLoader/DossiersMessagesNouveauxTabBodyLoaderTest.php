...
class DossiersMessagesNouveauxTabBodyLoaderTest extends TestCase
{
    public function testLoadFillsTabBodyWithExpectedData(): void
    {
        ...
        $this->assertSame('oui', $filters['isNouveauMessage']);
        $this->assertNull($filters['showMySignalementsOnly']);
        $this->assertSame('back/dashboard/tabs/dossiers_messages_usagers/_body_dossier_messages_nouveaux.html.twig', $tabBody->getTemplate());
    }
}
