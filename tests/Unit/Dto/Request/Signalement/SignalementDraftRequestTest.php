...
class SignalementDraftRequestTest extends WebTestCase
{
    ...
    {
        $signalementDraftRequest = $this->getGoodSignalementDraftRequest();
    ...
    public function testValidateFailed(): void
    {
        ...
        $signalementDraftRequest->setProfil('invalid_profil')
            ...
            ->setAdresseLogementComplementAdresseEtage('AILLEURS')
            ...
            ->setLogementSocialDateNaissance((new \DateTimeImmutable('tomorrow'))->format('Y-m-d'))
            ...
            ->setInformationsComplementairesSituationOccupantsDateNaissance((new \DateTimeImmutable('tomorrow'))->format('Y-m-d'))
            ...
            ->setInformationsComplementairesSituationBailleurDateNaissance((new \DateTimeImmutable('tomorrow'))->format('Y-m-d'))
    ...
    {
        $signalementDraftRequest = $this->getGoodSignalementDraftRequest();
        $signalementDraftRequest->setCompositionLogementNombreEnfants('8');
    ...
    private function getGoodSignalementDraftRequest(): SignalementDraftRequest
    {
        ...
        $signalementDraftRequest
            ...
            ->setCompositionLogementNombreEnfants('2')
        ...
        return $signalementDraftRequest;
    }
}
