...
class SignalementRepositoryTest extends KernelTestCase
{
    ...
    {
        /** @var SignalementRepository $repo */
        $repo = $this->entityManager->getRepository(Signalement::class);
        /** @var UserRepository $userRepository */
        $userRepository = $this->entityManager->getRepository(User::class);
        ...
        $count = $repo->countSignalementsSansAffectationAcceptee($user, $params);
    ...
    public function testFindSignalementsSansAffectationAcceptee(): void
    {
        ...
        $results = $repo->findSignalementsSansAffectationAcceptee($user, $params);
    ...
    public function testFindSignalementsSansAffectationAccepteeSortByAffectedAt(): void
    {
        ...
        $user = $this->entityManager->getRepository(User::class)
            ->findOneBy(['email' => self::USER_PARTNER_TERRITORY_13]);
