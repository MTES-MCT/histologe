...
class VisiteCreateControllerTest extends WebTestCase
{
    ...
    public function testCreateVisite(string $signalementUuid, bool $notifyUsager, int $nbMailSent): void
    {
        ...
        $this->client->request(
            method: 'POST',
            uri: $this->router->generate('api_signalements_visite_post', ['uuid' => '00000000-0000-0000-2022-000000000006']),
    ...
    {
        yield 'test create visite with usager notification' => ['00000000-0000-0000-2022-000000000006', true, 2];
        yield 'test create visite with no usager notification' => ['00000000-0000-0000-2022-000000000006', false, 1];
    }
}
