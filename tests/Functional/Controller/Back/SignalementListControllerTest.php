...
class SignalementListControllerTest extends WebTestCase
{
    ...
    public static function provideNewFilterSearch(): \Generator
    {
        ...
        yield 'Search by Allocataire Non (null+empty)' => [['allocataire' => 'non', 'isImported' => 'oui'], 14];
        ...
        yield 'Search by Occupation logement Occupé locataire' => [['occupationLogement' => 'logement_occupe_locataire', 'isImported' => 'oui'], 16];
        ...
        yield 'Search by Created from CREATED_FROM_FORMULAIRE_PRO' => [['createdFrom' => CreationSource::CREATED_FROM_FORMULAIRE_PRO], 11];
