...
class SignalementListControllerTest extends WebTestCase
{
    ...
    public function provideNewFilterSearch(): \Generator
    {
        ...
        yield 'Search by Allocataire Non (null+empty)' => [['allocataire' => 'non', 'isImported' => 'oui'], 12];
        yield 'Search by Situation Bail en cours' => [['situation' => 'bail_en_cours', 'isImported' => 'oui'], 15];
