...
class SignalementListControllerTest extends WebTestCase
{
    ...
    public function provideNewFilterSearch(): \Generator
    {
        ...
        yield 'Search by Declarant' => [['typeDeclarant' => 'locataire', 'isImported' => 'oui'], 50];
        ...
        yield 'Search by Allocataire Non (null+empty)' => [['allocataire' => 'non', 'isImported' => 'oui'], 11];
        yield 'Search by Situation Bail en cours' => [['situation' => 'bail_en_cours', 'isImported' => 'oui'], 14];
        ...
        yield 'Search by Signalement Imported' => [['isImported' => 'oui'], 55];
