...
class SignalementListControllerTest extends WebTestCase
{
    ...
    public function provideNewFilterSearch(): \Generator
    {
        ...
        yield 'Search by Enfant moins de 6ans (non)' => [['enfantsM6' => 'non'], 2];
        yield 'Search by Enfant moins de 6ans (oui)' => [['enfantsM6' => 'oui'], 45];
        yield 'Search by Enfant moins de 6ans (non_renseignee)' => [['enfantsM6' => 'non_renseigne'], 0];
        yield 'Search by Date de depot' => [['dateDepotDebut' => '2023-03-08', 'dateDepotFin' => '2023-03-16'], 2];
        yield 'Search by Procédure estimée' => [['procedure' => 'rsd'], 6];
        ...
        yield 'Search by Declarant' => [['typeDeclarant' => 'locataire'], 42];
        yield 'Search by Nature du parc' => [['natureParc' => 'public'], 5];
        yield 'Search by Allocataire CAF' => [['allocataire' => 'caf'], 15];
        yield 'Search by Allocataire MSA' => [['allocataire' => 'msa'], 1];
        yield 'Search by Allocataire Oui (CAF+MSA+1)' => [['allocataire' => 'oui'], 16];
        yield 'Search by Allocataire Non (null+empty)' => [['allocataire' => 'non'], 4];
        yield 'Search by Situation Bail en cours' => [['situation' => 'bail_en_cours'], 6];
        ...
        yield 'Search by Signalement Imported' => [['isImported' => 'oui'], 47];
    }
