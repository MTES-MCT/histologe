...
class SignalementCreateControllerTest extends WebTestCase
{
    ...
    public function testCreateWithDoublon(): void
    {
        ...
        $this->assertEquals(44, $signalements[1]->getAddress()->getTerritory()->getZip());
    }
    ...
    public function testCreateWithDoublonDraft(): void
    {
        ...
        $signalements = $this->signalementRepository->findByAddress(null, 'Route des Funeries', '44850', 'Le Cellier');
    ...
    public function testEditAddress(): void
    {
        ...
        $this->assertEquals(44, $signalement->getAddress()->getTerritory()->getZip());
        $this->assertEquals('5', $signalement->getAddress()->getHousenumber());
        $this->assertEquals('Rue Basse', $signalement->getAddress()->getStreet());
        $this->assertEquals('44350', $signalement->getAddress()->getPostCode());
        $this->assertEquals('Guérande', $signalement->getAddress()->getCity());
