...
{
    public const int MAX_FILESIZE = 25 * 1024 * 1024;
    public const int MAX_FILESIZE_FO = 10 * 1024 * 1024;
    ...
    public function toTempFolder(
        ...
        ?int $maxFileSize = self::MAX_FILESIZE,
    ): array {
        ...
        $this->isFileSizeOk($file, $maxFileSize);
