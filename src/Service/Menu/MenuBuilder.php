...
readonly class MenuBuilder
{
    ...
    public function build(): MenuItem
    {
        ...
        $signalementsSubMenu->addChild(new MenuItem(label: 'Dossiers à la même adresse', route: 'back_signalement_same_address_index', roleGranted: User::ROLE_USER));
        $signalementsSubMenu
        ...
        if ($this->featureMetabaseStats) {
            $donneesChiffreesSubMenu
                ->addChild(new MenuItem(label: 'Statistiques (version beta)', route: 'back_beta_statistiques', roleGranted: User::ROLE_USER));
        }
        ...
        $superAdminToolsSubItem
            ...
            ->addChild(new MenuItem(route: 'back_auto_assigner_simulator_index'))
        ;
