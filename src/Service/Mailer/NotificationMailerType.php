...
enum NotificationMailerType
{
    ...
    case TYPE_ASK_TRAVAUX_MISE_EN_CONFORMITE;
    case TYPE_SIGNALEMENT_DRAFT_PENDING_BAILLEUR_PREVENU;
    case TYPE_SIGNALEMENT_EDIT_MAIL_OCCUPANT;
    case TYPE_CONFIRM_RECEPTION_TO_USAGER;
    case TYPE_CONFIRM_INJONCTION_TO_USAGER;
    case TYPE_CONFIRM_INJONCTION_TO_BAILLEUR;
    case TYPE_REMINDER_TO_BAILLEUR;
    case TYPE_REMINDER_CLOTURE_TO_USAGER;
    case TYPE_REMINDER_CLOTURE_AND_CLOSE_TO_USAGER;
    case TYPE_REMINDER_CLOTURE_AND_CLOSE_TO_BAILLEUR;
    case TYPE_SIGNALEMENT_INJONCTION_CLOSED_TO_BAILLEUR;
    case TYPE_SIGNALEMENT_INJONCTION_CLOSED_TO_USAGER;
    case TYPE_NEW_COMMENT_FOR_BAILLEUR;
    ...
    case TYPE_INVITE_TIERS;
    case TYPE_NOTIFICATIONS_SUMMARY;
    case TYPE_DEMANDE_ABANDON_PROCEDURE_TO_USAGER;
    case TYPE_DEMANDE_ABANDON_PROCEDURE_TO_OTHER_USAGER;
    case TYPE_DEMANDE_ABANDON_PROCEDURE_TO_ADMIN;
    case TYPE_USAGER_CLOSE_INJONCTION_TO_BAILLEUR;
    case TYPE_BAILLEUR_CLOSE_INJONCTION_TO_USAGER;
