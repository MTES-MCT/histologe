...
class SignalementClosedToOnePartnerMailer extends AbstractNotificationMailer
{
    ...
    public function getMailerParamsFromNotification(NotificationMail $notificationMail): array
    {
        ...
        return [
            ...
            'partner_name' => $user->getPartnerInTerritory($signalement->getTerritory())?->getNom() ?? $user->getPartners()->first()->getNom(),
    ...
    public function updateMailerSubjectFromNotification(NotificationMail $notificationMail): void
    {
        ...
        $this->mailerSubject = \sprintf(
            ...
            $user->getPartnerInTerritory($signalement->getTerritory())?->getNom() ?? $user->getPartners()->first()->getNom(),
        );
    }
}
