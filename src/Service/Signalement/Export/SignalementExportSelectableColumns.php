...
class SignalementExportSelectableColumns
{
    ...
    private const array SELECTABLE_COLS = [
        ...
        'ADRESSE_OCCUPANT' => ['name' => 'Adresse', 'description' => 'L\'adresse postale du logement', 'export' => 'address.housenumber AS addressHousenumber, address.street AS addressStreet', 'preselected' => true],
        'CP_OCCUPANT' => ['name' => 'Code postal', 'description' => 'Le code postal du logement', 'export' => 'address.postCode AS addressPostcode', 'preselected' => true],
        'VILLE_OCCUPANT' => ['name' => 'Commune', 'description' => 'La commune du logement', 'export' => 'address.city AS addressCity', 'preselected' => true],
        'INSEE' => ['name' => 'Code INSEE', 'description' => 'Le code INSEE de la commune du signalement', 'export' => 'address.cityCode AS addressCityCode', 'preselected' => false],
        ...
        'GEOLOCALISATION' => ['name' => 'Géolocalisation', 'description' => 'Les coordonnées GPS du logement', 'export' => 's.geoloc, address.point as addressPoint', 'preselected' => false],
