...
readonly class DossiersMessagesApresFermetureTabDataLoader implements TabDataLoaderInterface
{
    ...
    public function load(TabData $tabData): void
    {
        ...
        $tabData->setTemplate('back/dashboard/tabs/data/dossiers_messages_usagers/_data_dossier_messages_apres_fermeture.html.twig');
    }

    public function supports(string $type): bool
    {
        return TabDataType::TAB_DATA_TYPE_DOSSIERS_MESSAGES_APRES_FERMETURE === $type;
    }
}
