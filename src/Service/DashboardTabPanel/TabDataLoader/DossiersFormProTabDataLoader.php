...
readonly class DossiersFormProTabDataLoader implements TabDataLoaderInterface
{
    ...
    {
        $tabData->setData($this->tabDataManager->getDossiersFormPro());
        $tabData->setTemplate('back/dashboard/tabs/data/dossiers_nouveaux/_data_dossier_pro.html.twig');
    }

    public function supports(string $type): bool
    {
        return TabDataType::TAB_DATA_TYPE_DOSSIERS_FORM_PRO === $type;
    }
}
