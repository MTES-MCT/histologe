...
readonly class DossierDemandesFermetureUsagerTabDataLoader implements TabDataLoaderInterface
{
    ...
    public function load(TabData $tabData): void
    {
        ...
        $tabData->setTemplate('back/dashboard/tabs/data/dossiers_a_fermer/_data_dossier_demande_fermeture_usager.html.twig');
    }

    public function supports(string $type): bool
    {
        return TabDataType::TAB_DATA_TYPE_DOSSIERS_DEMANDE_FERMETURE_USAGER === $type;
    }
}
