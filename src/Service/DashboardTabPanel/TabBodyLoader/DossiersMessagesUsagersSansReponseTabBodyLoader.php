...
readonly class DossiersMessagesUsagersSansReponseTabBodyLoader implements TabBodyLoaderInterface
{
    ...
    {
        return TabBodyType::TAB_DATA_TYPE_DOSSIERS_MESSAGES_USAGERS_SANS_REPONSE === $type;
    }
}
