...
class SignalementExportFactory
{
    ...
    public function createInstanceFrom(User $user, array $data): SignalementExport
    {
        ...
        return new SignalementExport(
            ...
            codePostalProprio: $data['codePostalProprio'] ?? '-',
            villeProprio: $data['villeProprio'] ?? '-',
            telProprio: $data['telProprio'] ?? '-',
            telProprioSecondaire: $data['telProprioSecondaire'] ?? '-',
            mailProprio: $data['mailProprio'] ?? '-',
