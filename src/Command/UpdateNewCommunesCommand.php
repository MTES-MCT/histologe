...
#[AsCommand(
    name: 'app:update-new-communes',
    description: 'Update new communes from data.gouv csv file'
)]
class UpdateNewCommunesCommand extends Command
{
    ...
    protected function initialize(InputInterface $input, OutputInterface $output): void
    {
        ...
        $this->csvData = $this->csvParser->parse($this->parameterBag->get('new_communes_csv_url'));
    }
