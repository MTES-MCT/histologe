...
class SynchronizeEsaboraSISHCommand extends AbstractCronCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->messageBus->dispatch(new SyncEsaboraSISHMessage($uuidSignalement));

        $output->writeln('SISH synchronization message dispatched.');
