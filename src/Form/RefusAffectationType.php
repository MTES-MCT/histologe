...
class RefusAffectationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ->add('motifRefus', EnumType::class, [
                ...
                'choices' => [
                    MotifRefus::HORS_ZONE_GEOGRAPHIQUE,
            ...
            ->add('description', TextareaType::class, [
                'label' => 'Message aux partenaires <span class="fr-text-default--error">*</span>',
                'label_html' => true,
                'help' => 'Expliquez aux autres partenaires la raison du refus de ce signalement <em>(10 caractères minimum)</em>',
                'help_html' => true,
                'attr' => [
                    'class' => 'editor',
                ],
            ...
            ->add('files', SearchCheckboxType::class, [
                ...
                'choice_label' => 'title',
                'label' => 'Fichiers',
                'noselectionlabel' => 'Sélectionnez une ou plusieurs fichiers à joindre au message',
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => RefusAffectation::class,
        ]);
    }
}
