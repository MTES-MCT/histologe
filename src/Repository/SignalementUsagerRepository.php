 ...
 * @method SignalementUsager|null findOneBy(array<string, mixed> $criteria, array<string, mixed>|null $orderBy = null)
 * @method SignalementUsager[]    findAll()
 * @method SignalementUsager[]    findBy(array<string, mixed> $criteria, array<string, mixed>|null $orderBy = null, $limit = null, $offset = null)
 */
