...
class SignalementRepository extends ServiceEntityRepository
{
     ...
     * @return array<int, array<string, array<int|string|null>|int|string>|string>
     */
    private function getBaseSignalementsSansAffectationAccepteeSql(
        User $user,
        TabQueryParameters $params,
    ): array {
        $paramsToBind = [];
    ...
    public function countSignalementsSansAffectationAcceptee(User $user, ?TabQueryParameters $params): int
    {
        $conn = $this->getEntityManager()->getConnection();
        ...
        /** @var array<mixed> $paramsToBind */
        /** @var array<mixed> $types */
        [$sqlPrincipal, $paramsToBind, $types] = $this->getBaseSignalementsSansAffectationAccepteeSql($user, $params);
        $sql .= $sqlPrincipal;
     ...
     * @return array<int, array<string, mixed>>
     */
    public function findSignalementsSansAffectationAcceptee(User $user, ?TabQueryParameters $params): array
    {
        $conn = $this->getEntityManager()->getConnection();
