...
class DesordreRequest implements RequestInterface
{
    ...
    #[Assert\All([
        new Assert\Choice(choices: [
            ...
            'desordres_logement_humidite_tout_details_machine_oui',
            'desordres_logement_humidite_tout_details_machine_non',
            'desordres_logement_humidite_tout_details_machine_nsp',
            'desordres_logement_humidite_tout_details_moisissure_apres_nettoyage_oui',
            'desordres_logement_humidite_tout_details_moisissure_apres_nettoyage_non',
            'desordres_logement_humidite_tout_details_moisissure_apres_nettoyage_nsp',
            'desordres_logement_humidite_tout_details_fuite_oui',
            'desordres_logement_humidite_tout_details_fuite_non',
