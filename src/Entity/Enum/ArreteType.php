...
enum ArreteType: string
{
    ...
    public static function getLabelList(): array
    {
        return [
            ...
            self::ARRETE_L_511_11_IMPROPRE->name => 'Impropre',
            self::ARRETE_L_511_11_ORDINAIRE_IRREMEDIABLE->name => 'Ordinaire irrémédiable',
            self::ARRETE_L_511_11_ORDINAIRE_REMEDIABLE->name => 'Ordinaire remédiable',
            self::ARRETE_L_511_11_SUROCCUPATION->name => 'Suroccupation',
            self::ARRETE_L_511_11_USAGE_NON_APPROPRIE->name => 'Usage non approprié',
            self::ARRETE_L_511_19_INSALUBRITE->name => 'Insalubrité',
            self::ARRETE_L_511_19_INSALUBRITE_SATURNISME->name => 'Insalubrité & Saturnisme',
            self::ARRETE_L_511_19_SATURNISME->name => 'Saturnisme',
    ...
    /** @return array<string, string> */
    public static function getCompleteLabelInMapViewList(): array
    {
        return [
    ...
    public function completeLabelInMapView(): string
    {
        return self::getCompleteLabelInMapViewList()[$this->name];
    }
