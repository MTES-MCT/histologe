...
class TabPanelVoter extends Voter
{
    ...
    private function getAccessConfig(): array
    {
        return [
            ...
            TabBodyType::TAB_DATA_TYPE_DOSSIERS_FERME_COMMUNE => ['ROLE_ADMIN', 'ROLE_ADMIN_TERRITORY'],
            ...
            TabBodyType::TAB_DATA_TYPE_SANS_AFFECTATION_ACCEPTEE => ['ROLE_ADMIN', 'ROLE_ADMIN_TERRITORY'],
            TabBodyType::TAB_DATA_TYPE_ADRESSE_EMAIL_A_VERIFIER => ['ROLE_ADMIN', 'ROLE_ADMIN_TERRITORY', 'ROLE_ADMIN_PARTNER', 'ROLE_USER_PARTNER'],
            TabBodyType::TAB_DATA_TYPE_DOSSIERS_ACTIVITE_RECENTE => ['ROLE_ADMIN', 'ROLE_ADMIN_TERRITORY', 'ROLE_ADMIN_PARTNER', 'ROLE_USER_PARTNER'],
        ];
    }
}
