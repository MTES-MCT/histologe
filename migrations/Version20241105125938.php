...
final class Version20241105125938 extends AbstractMigration
{
    ...
    {
        // create user_partner table
        $this->addSql('CREATE TABLE user_partner (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, partner_id INT NOT NULL, INDEX IDX_6926201CA76ED395 (user_id), INDEX IDX_6926201C9393F8FE (partner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('INSERT INTO user_partner (user_id, partner_id) SELECT id, partner_id FROM user WHERE partner_id IS NOT NULL');
    }
