...
final class Version20260213152012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // mettre la valeur 'FORM_PRO_BO' pour ceux qui n'ont pas encore de source et pour qui created_by_id n'est pas null
        $this->addSql("UPDATE signalement SET creation_source = '".CreationSource::FORM_PRO_BO->value."' WHERE creation_source IS NULL AND created_by_id IS NOT NULL");
