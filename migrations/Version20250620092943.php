...
final class Version20250620092943 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add suivi_file table and is_standalone column to file table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE suivi_file ADD CONSTRAINT FK_3CBF617293CB796C FOREIGN KEY (file_id) REFERENCES file (id)
        SQL);
        $this->addSql(<<<'SQL'
