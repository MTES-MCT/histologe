...
final class Version20230616132430 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, uploaded_by_id INT DEFAULT NULL, signalement_id INT NOT NULL, filename VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, file_type VARCHAR(32) NOT NULL, INDEX IDX_8C9F3610A76ED395 (uploaded_by_id), INDEX IDX_8C9F361065C5E57E (signalement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F3610A76ED395 FOREIGN KEY (uploaded_by_id) REFERENCES user (id)');
