...
final class Version20240624153853 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE history_entry (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, event VARCHAR(255) NOT NULL, entity_id INT DEFAULT NULL, entity_name VARCHAR(255) NOT NULL, INDEX IDX_8F3F68C5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
